...
const unsigned char PROGMEM timinoo_logo_128x64[] = {
...
void setup() {
    ...
    M5.Lcd.drawXBitmap(56, 30, timinoo_logo_128x64, timinoo_logo_128x64_width, timinoo_logo_128x64_height, TFT_WHITE);
}
